...
class FileIODisconnectionError extends CustomError {
  readonly type = "FileIODisconnectionError";
  readonly status = 205;
  readonly code = "FILE_IO_DISCONNECTION_ERROR";
  readonly message = "An error happened while disconnecting from the remote filesystem.";
...
export default FileIODisconnectionError;
