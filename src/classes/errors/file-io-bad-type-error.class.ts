...
class FileIOBadTypeError extends CustomError {
  readonly type = "FileIOBadTypeError";
  readonly status = 202;
  readonly code = "FILE_IO_BAD_TYPE_ERROR";
  readonly message =
    "The object found in the path is of the wrong type.";
...
export default FileIOBadTypeError;
