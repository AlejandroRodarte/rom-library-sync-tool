...
class ParserProcessingError extends CustomError {
  readonly type = "ParserProcessingError";
  readonly status = 300;
  readonly code = "PARSER_PROCESSING_ERROR";
  readonly message =
    "The object in question failed to get processed during parsing.";
...
export default ParserProcessingError;
