...
class AppExistsError extends CustomError {
  readonly type = "AppExistsError";
  readonly status = 101;
  readonly code = "APP_EXISTS_ERROR";
  readonly message = "There is already an entity in app memory.";
