...
class FileIOCircularReferenceError extends CustomError {
  readonly type = "FileIOCircularReferenceError";
  readonly status = 203;
  readonly code = "FILE_IO_CIRCULAR_REFERENCE_ERROR";
  readonly message =
...
export default FileIOCircularReferenceError;
