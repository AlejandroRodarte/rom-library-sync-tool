...
class AppFailedContentExistsError extends CustomError {
  readonly type = "AppConversionError";
  readonly status = 105;
  readonly code = "APP_FAILED_CONTENT_EXISTS_ERROR";
  readonly message = "Some content failed to synchronize at the end of a `sync` stage.";
...
export default AppFailedContentExistsError;
