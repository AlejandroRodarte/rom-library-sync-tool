...
class FileIOBadPathError extends CustomError {
  readonly type = "FileIOBadPathError";
  readonly status = 201;
  readonly code = "FILE_IO_BAD_PATH_ERROR";
  readonly message = "The provided path is faulty.";
...
export default FileIOBadPathError;
